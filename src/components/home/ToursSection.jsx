...
import styles from '../../../styles/components/home/tours-section.scss';

const ToursSection = () => (
  <section styleName="tours-section">
    ...
    <div className="u-center-text u-margin-top-big">
      <a href="http://localhost:8081" className="btn btn--green ">Discover all tours</a>
    </div>
  </section>
);
